...
class Jugador(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.color = VERD
        pygame.draw.circle(self.image, self.color, (100, 100), 50)
...
quadrat1 = Jugador()
quadrat2= Jugador()
quadrat2.rect.center = (200,200)
quadrat2.image.fill(BLAU)
sprites.add(quadrat1)
sprites.add(quadrat2)
